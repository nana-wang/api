...
use Phalcon\Mvc\Model, DwComment\Exceptions\HttpException, Phalcon\Mvc\Model\Validator\Uniqueness;
...
class Users extends Model
{
    ...
    /**
     * Validates a model before submitting it for creation or deletion.
     * Our Princess model
    ...
    public function validation()
    {
        ...
        if ($this->validationHasFailed() == true) {
            throw new HttpException($this->appendMessage($this->getMessages()), 417);
        }
