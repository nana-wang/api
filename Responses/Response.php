<?php
namespace DwComment\Responses;
use Phalcon\Di\Injectable, Phalcon\Di;
...
class Response extends Injectable {
    ...
    /**
     * Replaces underscores with spaces, uppercases the first letters of each
     * word,
    ...
    protected function snakeToCamel ($val) {
        return (strtoupper($val) === $val ? $val : str_replace(' ', '', 
